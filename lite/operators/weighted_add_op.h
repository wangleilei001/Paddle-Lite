...
class WeightedAddOpLite : public OpLite {
 public:
  WeightedAddOpLite() {}

  explicit WeightedAddOpLite(const std::string &type) : OpLite(type) {}
  ...
  std::string DebugString() const override { return "WeightedAdd"; }
 ...
 private:
  mutable WeightedAddParam param_;
};
